          ...
          switch (ctx.targetMode) {
            ...
            case 'branch': {
              ...
              await downloadExtractZip(task, {
                ...
                url: `https://github.com/khulnasoft-lab/ietf-tracker/archive/refs/heads/${branch}.tar.gz`,
                ext: 'tgz'
              })
            ...
            case 'tag': {
              ...
              await downloadExtractZip(task, {
                ...
                url: `https://github.com/khulnasoft-lab/ietf-tracker/archive/refs/tags/${tag}.tar.gz`,
                ext: 'tgz'
              })
            ...
            case 'commit': {
              ...
              await downloadExtractZip(task, {
                ...
                url: `https://github.com/khulnasoft-lab/ietf-tracker/archive/${commit}.tar.gz`,
                ext: 'tgz'
              })
            ...
            case 'release': {
              ...
              await downloadExtractZip(task, {
                ...
                url: 'https://github.com/khulnasoft-lab/ietf-tracker/releases/latest/download/release.tar.gz',
                ext: 'tgz'
              })
