...
[![Release](https://img.shields.io/github/release/ietf-tools/datatracker.svg?style=flat&maxAge=300)](https://github.com/khulnasoft-lab/ietf-tracker/releases)
[![License](https://img.shields.io/github/license/ietf-tools/datatracker)](https://github.com/khulnasoft-lab/ietf-tracker/blob/main/LICENSE)
...
- [Changelog](https://github.com/khulnasoft-lab/ietf-tracker/releases)
- [Contributing](https://github.com/khulnasoft-lab/.github/blob/main/CONTRIBUTING.md)
...
This project is following the standard **Git Feature Workflow** development model. Learn about all the various steps of the development workflow, from creating a fork to submitting a pull request, in the [Contributing](https://github.com/khulnasoft-lab/.github/blob/main/CONTRIBUTING.md) guide.

> Make sure to read the [Styleguides](https://github.com/khulnasoft-lab/.github/blob/main/CONTRIBUTING.md#styleguides) section to ensure a cohesive code format across the project.

You can submit bug reports, enhancement and new feature requests in the [discussions](https://github.com/khulnasoft-lab/ietf-tracker/discussions) area. Accepted tickets will be converted to issues.
...
As outlined in the [Contributing](https://github.com/khulnasoft-lab/.github/blob/main/CONTRIBUTING.md) guide, you will first want to create a fork of the datatracker project in your personal GitHub account before cloning it.

Windows developers: [Start with WSL2 from the beginning](https://github.com/khulnasoft-lab/.github/blob/main/docs/windows-dev.md).
